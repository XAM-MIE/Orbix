        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-6">
              ...
              >
                Create your account and unlock the power of AI-driven development. Build faster, smarter, and more efficiently.
              </motion.p>
            </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-muted-foreground">Free forever plan with generous limits</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center">
                  <Zap className="w-4 h-4 text-blue-500" />
                </div>
                <span className="text-sm text-muted-foreground">Instant access to AI-powered tools</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-lg bg-purple-500/10 flex items-center justify-center">
                  <Shield className="w-4 h-4 text-purple-500" />
                </div>
                <span className="text-sm text-muted-foreground">Enterprise-grade security & privacy</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-lg bg-orange-500/10 flex items-center justify-center">
                  <Star className="w-4 h-4 text-orange-500" />
                </div>
                <span className="text-sm text-muted-foreground">Join 10,000+ developers worldwide</span>
              </div>
            </motion.div>
          </motion.div>
              ...
              <Card className="border-0 shadow-2xl bg-card/80 backdrop-blur-lg transition-all duration-300 hover:shadow-3xl hover:scale-[1.02]">
                ...
                <CardContent className="space-y-6">
                  ...
                  >
                    ...
                    <Link href="/login" className="font-medium text-purple-600 hover:text-purple-500 hover:underline transition-colors">
                      Sign in
                    </Link>
                  </motion.div>
                </CardContent>
